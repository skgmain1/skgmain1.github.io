document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ru: {
            ...
            product_hub_v2_title: "Expensive Hub v2",
            product_hub_v2_desc: "Включает: AUT Basic, Hunters Script, Dead Rails Script, JailBreak v1 Script, Blade Ball Script, Combat Warriors.",
            product_rollback_bundle_title: "All Rollback Scripts Bundle",
            product_rollback_bundle_desc: "Включает: Blue Lock: Rivals Script, VolleyBall Legends Script.",
            product_gpo_title: "GPO 3.0",
            product_gpo_desc: "Премиум скрипт для игры GPO 3.0. Максимальная эффективность и производительность.",
            product_brainrot_title: "Steal a Brainrot",
            product_brainrot_desc: "Премиум скрипт для игры Steal a Brainrot. Максимальная эффективность и производительность.",
            product_yba_title: "YBA Script",
            product_yba_desc: "Премиум скрипт для игры YBA. Максимальная эффективность и производительность.",
            product_99nights_title: "99 Nights [Kaitun] Script",
            product_99nights_desc: "Премиум скрипт для игры 99 Nights. Максимальная эффективность и производительность.",
            ...
            product_farmv2_title: "Resources Farm v2 Script",
            ...
            product_level_basic_title: "Level Special [Basic Version]",
            product_level_basic_desc: "Скрипт для автоматического фарма уровня на базе юшардов и юкойнов. Примерная скорость фарма 10-15 асков за 3-5 секунд. Включает автотрейт в4 и авто реролл статов.",
            product_level_farmer_title: "Level Special [Farmer Version]",
            product_level_farmer_desc: "Продвинутый, самый быстрый с максимальной скоростью, с поддержкой VPS, нескольких аккаунтов и многими другими функциями для еще большего фарма.",
            product_spectool_title: "Spec Tool v2 Script",
            product_spectool_desc: "Премиум скрипт Spec Tool v2. Максимальная эффективность и производительность.",
            ...
            product_aotr_title: "AOTR Script",
            product_aotr_desc: "Лучший автоматический скрипт для фарма AOTR, необнаружимый и безопасный.",
            product_bluelock_rollback_title: "Blue Lock: Rivals Rollback Script",
            product_bluelock_rollback_desc: "Скрипт на игру Блюлок Райвалс. Лучший автоматический роллбек / инфинити спинс скрипт, быстрейший автофарм и многое другое!",
            product_vball_rollback_title: "VolleyBall Legends Rollback Script",
            product_vball_rollback_desc: "Лучший скрипт для роллбека в VolleyBall Legends.",
            product_growagarden_title: "Grow a Garden Script",
            product_growagarden_desc: "Премиум скрипт для Grow a Garden. ВРЕМЕННАЯ СКИДКА.",
        ...
        en: {
            ...
            product_hub_v2_title: "Expensive Hub v2",
            product_hub_v2_desc: "Includes: AUT Basic, Hunters Script, Dead Rails Script, JailBreak v1 Script, Blade Ball Script, Combat Warriors.",
            product_rollback_bundle_title: "All Rollback Scripts Bundle",
            product_rollback_bundle_desc: "Includes: Blue Lock: Rivals Script, VolleyBall Legends Script.",
            product_gpo_title: "GPO 3.0",
            product_gpo_desc: "Premium script for the game GPO 3.0. Maximum efficiency and performance.",
            product_brainrot_title: "Steal a Brainrot",
            product_brainrot_desc: "Premium script for the game Steal a Brainrot. Maximum efficiency and performance.",
            product_yba_title: "YBA Script",
            product_yba_desc: "Premium script for the game YBA. Maximum efficiency and performance.",
            product_99nights_title: "99 Nights [Kaitun] Script",
            product_99nights_desc: "Premium script for the game 99 Nights. Maximum efficiency and performance.",
            product_farmv1_title: "Resources Farm v1 Script",
            ...
            product_level_basic_title: "Level Special [Basic Version]",
            product_level_basic_desc: "Script for automatic level farming based on UShards and YCoins. Approx. speed: 10-15 ASKs per 3-5 seconds. Includes autotrait v4 and auto reroll stats.",
            product_level_farmer_title: "Level Special [Farmer Version]",
            product_level_farmer_desc: "Advanced, Most Fastest With Maximum Amount Of Speed, With Support VPS, Multi Accounts, And Much More Features Included For Farming More.",
            product_spectool_title: "Spec Tool v2 Script",
            product_spectool_desc: "Premium script Spec Tool v2. Maximum efficiency and performance.",
            product_ghoul_title: "Ghoul://RE Script",
            ...
            product_aotr_title: "AOTR Script",
            product_aotr_desc: "Best automated farming script for AOTR, undetected & safe.",
            product_bluelock_rollback_title: "Blue Lock: Rivals Rollback Script",
            product_bluelock_rollback_desc: "Script for Blue Lock Rivals. Best automatic rollback / infinity spins script, fastest autofarm, and much more!",
            product_vball_rollback_title: "VolleyBall Legends Rollback Script",
            product_vball_rollback_desc: "Best rollback script for VolleyBall Legends.",
            product_growagarden_title: "Grow a Garden Script",
            product_growagarden_desc: "Premium script for Grow a Garden. TEMPORARILY DISCOUNTED.",
        ...
        es: {
            ...
            product_hub_v2_title: "Expensive Hub v2",
            product_hub_v2_desc: "Incluye: AUT Basic, Hunters Script, Dead Rails Script, JailBreak v1 Script, Blade Ball Script, Combat Warriors.",
            product_rollback_bundle_title: "Paquete de Todos los Scripts Rollback",
            product_rollback_bundle_desc: "Incluye: Blue Lock: Rivals Script, VolleyBall Legends Script.",
            product_gpo_title: "GPO 3.0",
            product_gpo_desc: "Script premium para el juego GPO 3.0. Máxima eficiencia y rendimiento.",
            product_brainrot_title: "Steal a Brainrot",
            product_brainrot_desc: "Script premium para el juego Steal a Brainrot. Máxima eficiencia y rendimiento.",
            product_yba_title: "YBA Script",
            product_yba_desc: "Script premium para el juego YBA. Máxima eficiencia y rendimiento.",
            product_99nights_title: "99 Nights [Kaitun] Script",
            product_99nights_desc: "Script premium para el juego 99 Nights. Máxima eficiencia y rendimiento.",
            ...
            product_farmv2_title: "Script Granja Recursos v2",
            ...
            product_level_basic_title: "Level Special [Versión Básica]",
            product_level_basic_desc: "Script para farmeo automático de nivel basado en UShards y YCoins. Velocidad aprox.: 10-15 ASKs cada 3-5 segundos. Incluye autotrait v4 y auto reroll stats.",
            product_level_farmer_title: "Level Special [Versión Farmer]",
            product_level_farmer_desc: "Avanzado, el más rápido con la máxima velocidad, con soporte para VPS, múltiples cuentas y muchas más funciones incluidas para farmear aún más.",
            product_spectool_title: "Spec Tool v2 Script",
            product_spectool_desc: "Script premium Spec Tool v2. Máxima eficiencia y rendimiento.",
            ...
            product_aotr_title: "Script AOTR",
            product_aotr_desc: "El mejor script de farmeo automático para AOTR, indetectable y seguro.",
            product_bluelock_rollback_title: "Script Rollback Blue Lock: Rivals",
            product_bluelock_rollback_desc: "Script para el juego Blue Lock Rivals. El mejor script de rollback automático / giros infinitos, autofarm más rápido, ¡y mucho más!",
            product_vball_rollback_title: "Script Rollback VolleyBall Legends",
            product_vball_rollback_desc: "El mejor script de rollback para VolleyBall Legends.",
            product_growagarden_title: "Script Grow a Garden",
            product_growagarden_desc: "Script premium para Grow a Garden. DESCUENTO TEMPORAL.",

            faq_title: "Preguntas Frecuentes",
            faq_q1_title: "¿Es seguro usar Expensive.cc Hub?",
            faq_a1_content: "Priorizamos la seguridad. Nuestros scripts se desarrollan сon métodos avanzados de evasión para minimizar el riesgo de detección. Sin embargo, usar cualquier script de terceros siempre conlleva algún riesgo.",
        ...
        Cache.translatables.forEach(el => {
            ...
            if (el.classList.contains('nav-link')) {
                ...
                el.innerHTML = translation;
                 ...
                 if (!el.classList.contains('stagger-letters') && !el.classList.contains('logo')) { el.textContent = translation; }
             } else if (el.classList.contains('logo') && key === 'logo_text') {
                 el.dataset.baseText = translation;
             }
        });
    ...
    const fetchAndUpdateStatus = () => {
        ...
        const simulatedStatus = {
            ...
            services: [
                ...
                { nameKey: "status_item_website", status: "operational" },
                { nameKey: "status_item_services", status: "operational" },
                { nameKey: "status_item_script_hub", status: "operational" },
            ]
        };
        ...
        if (Cache.statusBox.indicator && Cache.statusBox.title) {
            ...
            const titleTranslationKey = `status_main_title_${simulatedStatus.overall}`;
            Cache.statusBox.title.textContent = getTranslation(titleTranslationKey) || getTranslation('status_main_title_operational');
            Cache.statusBox.title.dataset.translateKey = titleTranslationKey;
        }
        if (Cache.statusBox.lastUpdateEl) {
             try {
                 Cache.statusBox.lastUpdateEl.textContent = simulatedStatus.lastUpdated.toLocaleString(state.currentLang || 'en-US', { dateStyle: 'medium', timeStyle: 'short' });
             } catch (e) {
                 Cache.statusBox.lastUpdateEl.textContent = simulatedStatus.lastUpdated.toLocaleDateString();
            }
        }
        if (Cache.statusBox.list) {
             Cache.statusBox.list.innerHTML = '';
             simulatedStatus.services.forEach(service => {
                 const li = document.createElement('li');
                 li.className = 'status-item';
                 const nameSpan = document.createElement('span');
                 nameSpan.className = 'status-item-name';
                 nameSpan.dataset.translateKey = service.nameKey;
                 nameSpan.textContent = getTranslation(service.nameKey);

                 const valueSpan = document.createElement('span');
                 const statusKey = `status_${service.status}`;
                 valueSpan.className = `status-item-value ${service.status}`;
                 valueSpan.dataset.translateKey = statusKey;
                 valueSpan.textContent = getTranslation(statusKey);

                 li.appendChild(nameSpan);
                 li.appendChild(valueSpan);
                 Cache.statusBox.list.appendChild(li);
             });
         } else {
            ...
            serviceItems?.forEach((item, index) => {
                 ...
                 if (!nameEl || !valueEl || index >= simulatedStatus.services.length) return;

                 const serviceData = simulatedStatus.services[index];
                 nameEl.dataset.translateKey = serviceData.nameKey;
                 nameEl.textContent = getTranslation(serviceData.nameKey);

                 const statusKey = `status_${serviceData.status}`;
                 valueEl.className = `status-item-value ${serviceData.status}`;
                 valueEl.dataset.translateKey = statusKey;
                 valueEl.textContent = getTranslation(statusKey);
             });
        }
    };
