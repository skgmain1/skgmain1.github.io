document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ru: {
            ...
            product_aut_desc: "Скрипт на несколько игр сразу: Aut Basic Version, Finger Farm v2, Hunters, Bubble Gum Simulator: Infinity, Grow A garden, Combat Warriors Script, JailBreak v1 AutoRob, Blade Ball Script, Dead Rails, Dead Rails [Kaitun Farm Bonds].",
            product_rollback_bundle_title: "Набор Всех Rollback Скриптов",
            product_rollback_bundle_desc: "Набор всех наших rollback скриптов для различных игр.",
            ...
            product_level_farmer_title: "Level Special [Farmer Version] Script",
            ...
            product_gag_kaitun_title: "Grow a Garden [Kaitun] Script",
            product_gag_kaitun_desc: "Самый стабильный, быстрый, оптимизированный скрипт Kaitun для GaG с крутыми визуальными эффектами.",
            product_aotr_title: "AOTR Script",
            product_aotr_desc: "Лучший автоматический скрипт для фарма AOTR, необнаружимый и безопасный.",
            product_bball_title: "BasketBall: Zero Script",
            product_bball_desc: "Лучший скрипт для роллбека в BasketBall: Zero.",
            product_vball_title: "VolleyBall Legends Script",
            product_vball_desc: "Лучший скрипт для роллбека в VolleyBall Legends.",
        ...
        en: {
            ...
            product_aut_title: "Expensive Hub [v2]",
            product_aut_desc: "Script for multiple games: Aut Basic Version, Finger Farm v2, Hunters, Bubble Gum Simulator: Infinity, Grow A garden, Combat Warriors Script, JailBreak v1 AutoRob, Blade Ball Script, Dead Rails, Dead Rails [Kaitun Farm Bonds]",
            product_rollback_bundle_title: "All Rollback Scripts Bundle",
            product_rollback_bundle_desc: "A bundle of all our rollback scripts for various games.",
            product_farmv1_title: "Resources Farm v1 Script",
            ...
            product_gag_kaitun_title: "Grow a Garden [Kaitun] Script",
            product_gag_kaitun_desc: "Most Stable, Faster, Optimized, Cool Visuals Kaitun Script For GaG",
            product_aotr_title: "AOTR Script",
            product_aotr_desc: "Best automated farming script for AOTR, undetected & safe.",
            product_bball_title: "BasketBall: Zero Script",
            product_bball_desc: "Best rollback script for BasketBall: Zero.",
            product_vball_title: "VolleyBall Legends Script",
            product_vball_desc: "Best rollback script for VolleyBall Legends.",
        ...
        es: {
            ...
            product_aut_title: "Expensive Hub [v2]",
            product_aut_desc: "Script para múltiples juegos: Aut Basic Version, Finger Farm v2, Hunters, Bubble Gum Simulator: Infinity, Grow A garden, Combat Warriors Script, JailBreak v1 AutoRob, Blade Ball Script, Dead Rails, Dead Rails [Kaitun Farm Bonds].",
            product_rollback_bundle_title: "Paquete de Todos los Scripts Rollback",
            product_rollback_bundle_desc: "Un paquete de todos nuestros scripts de rollback para varios juegos.",
            ...
            product_level_farmer_title: "Script Level Special [Versión Farmer]",
            ...
            product_gag_kaitun_title: "Script Grow a Garden [Kaitun]",
            product_gag_kaitun_desc: "El script Kaitun más estable, rápido, optimizado y con geniales efectos visuales para GaG.",
            product_aotr_title: "Script AOTR",
            product_aotr_desc: "El mejor script de farmeo automático para AOTR, indetectable y seguro.",
            product_bball_title: "Script BasketBall: Zero",
            product_bball_desc: "El mejor script de rollback para BasketBall: Zero.",
            product_vball_title: "Script VolleyBall Legends",
            product_vball_desc: "El mejor script de rollback para VolleyBall Legends.",
