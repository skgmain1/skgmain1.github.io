document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ru: {
            ...
            product_aut_desc: "Скрипт на несколько игр сразу: Aut Basic Version, Finger Farm v2, Hunters, Bubble Gum Simulator: Infinity, Grow A garden.",
        ...
        en: {
            ...
            product_aut_title: "Expensive Hub [v2]",
            product_aut_desc: "Script for multiple games: Aut Basic Version, Finger Farm v2, Hunters, Bubble Gum Simulator: Infinity, Grow A garden",
        ...
        es: {
            ...
            product_aut_title: "Expensive Hub [v2]",
            product_aut_desc: "Script para múltiples juegos: Aut Basic Version, Finger Farm v2, Hunters, Bubble Gum Simulator: Infinity, Grow A garden.",
